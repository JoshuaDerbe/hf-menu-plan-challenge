...
class MenuReview(BaseModel):
    ...
    class Meta:
        ...
        # one review for a specific menu.
        # As such, menu and user together should be the primary key.
        # There should never be two rows with the same menu and user.
        primary_key = CompositeKey("menu", "user")